!function (e) {
    ...
    var nullLogger = _$loggers_103.nullLogger, __debugLogger_102 = _$loggers_103.debugLogger, RestrictionError = function (e) {
        ...
        return n.on = function (e, t) {
            ...
            this.on("error", function (t) {
                ...
                e.getFile(t.id) ? e.setFileState(t.id, {progress: ___extends_102({}, e.getState().files[t.id].progress, {postprocess: r})}) : e.log("Not setting progress for a file that has been removed: " + t.id)
            }), this.on("postprocess-complete", function (t) {
                if (e.getFile(t.id)) {
                    var r = ___extends_102({}, e.getState().files);
                    r[t.id] = ___extends_102({}, r[t.id], {progress: ___extends_102({}, r[t.id].progress)}), delete r[t.id].progress.postprocess, e.setState({files: r})
                } else e.log("Not setting progress for a file that has been removed: " + t.id)
            ...
            var t = this, r = this.getState().currentUploads[e].step, n = [].concat(this.preProcessors, this.uploaders, this.postProcessors), o = Promise.resolve();
        ...
        return n.headers = function () {
            ...
            return new Promise(function (n, o) {
                r.preflightAndHeaders(e).then(function (i) {
                    fetch(r._getUrl(e), {method: "get", headers: i, credentials: "same-origin"}).then(r._getPostResponseFunc(t)).then(function (e) {
            ...
            return new Promise(function (o, i) {
                n.preflightAndHeaders(e).then(function (s) {
                    fetch(n._getUrl(e), {method: "post", headers: s, credentials: "same-origin", body: JSON.stringify(t)}).then(n._getPostResponseFunc(r)).then(function (e) {
            ...
            return new Promise(function (o, i) {
                n.preflightAndHeaders(e).then(function (s) {
                    fetch(n.hostname + "/" + e, {method: "delete", headers: s, credentials: "same-origin", body: t ? JSON.stringify(t) : null}).then(n._getPostResponseFunc(r)).then(function (e) {
                        return n._json(e).then(o)
                    }).catch(function (t) {
    ...
    var __h_114 = _$preact_53.h, _$FileItem_114 = _$pure_126(function (e) {
        var t = e.file, r = t.progress.preprocess || t.progress.postprocess, n = t.progress.uploadComplete && !r && !t.error, o = t.progress.uploadStarted || r, i = t.progress.uploadStarted && !t.progress.uploadComplete || r, s = t.isPaused || !1, a = t.error || !1, l = e.individualCancellation ? !n : !i && !n,
    ...
    }, __h_118 = _$preact_53.h, iconPlus = _$icons_119.iconPlus, uploadStates = {STATE_ERROR: "error", STATE_WAITING: "waiting", STATE_PREPROCESSING: "preprocessing", STATE_UPLOADING: "uploading", STATE_POSTPROCESSING: "postprocessing", STATE_COMPLETE: "complete", STATE_PAUSED: "paused"};
    ...
    }, _$StatusBarStates_156 = {STATE_ERROR: "error", STATE_WAITING: "waiting", STATE_PREPROCESSING: "preprocessing", STATE_UPLOADING: "uploading", STATE_POSTPROCESSING: "postprocessing", STATE_COMPLETE: "complete"}, _$secondsToTime_202 = function (e) {
    ...
    var __h_155 = _$preact_53.h, _$StatusBar_155 = function (e) {
        ...
        if (h === _$StatusBarStates_156.STATE_PREPROCESSING || h === _$StatusBarStates_156.STATE_POSTPROCESSING) {
            var g = function (e) {
                var t = [];
        ...
        var m = "number" == typeof f ? f : 100, y = h === _$StatusBarStates_156.STATE_WAITING && e.hideUploadButton || h === _$StatusBarStates_156.STATE_WAITING && !e.newFiles > 0 || h === _$StatusBarStates_156.STATE_COMPLETE && e.hideAfterFinish, v = !u && o && !s && !a && i && !c,
            b = !d && h !== _$StatusBarStates_156.STATE_WAITING && h !== _$StatusBarStates_156.STATE_COMPLETE, w = l && !p && h !== _$StatusBarStates_156.STATE_WAITING && h !== _$StatusBarStates_156.STATE_PREPROCESSING && h !== _$StatusBarStates_156.STATE_POSTPROCESSING && h !== _$StatusBarStates_156.STATE_COMPLETE, S = u && !_,
    ...
    var __Plugin_157 = _$lib_102.Plugin, _$lib_157 = (___temp_157 = ___class_157 = function (e) {
        ...
        return o.getTotalSpeed = function (e) {
            ...
            for (var n = _$StatusBarStates_156.STATE_WAITING, o = Object.keys(r), i = 0; i < o.length; i++) {
                ...
                s.preprocess && n !== _$StatusBarStates_156.STATE_UPLOADING && (n = _$StatusBarStates_156.STATE_PREPROCESSING), s.postprocess && n !== _$StatusBarStates_156.STATE_UPLOADING && n !== _$StatusBarStates_156.STATE_PREPROCESSING && (n = _$StatusBarStates_156.STATE_POSTPROCESSING)
            }
            return n
        }, o.render = function (e) {
    ...
    var _$lib_212 = (___temp_212 = ___class_212 = function (e) {
        ...
        function n(t, r) {
            ...
            var o = {
                formData: !0, fieldName: "files[]", method: "post", metaFields: null, responseUrlFieldName: "url", bundle: !1, headers: {}, timeout: 3e4, limit: 0, withCredentials: !1, responseType: "", getResponseData: function (e, t) {
                    var r = {};
                    try {
                        r = JSON.parse(e)
                    } catch (err) {
        ...
        return o.getOptions = function (e) {
            ...
            return new Promise(function (t, r) {
                ...
                (Array.isArray(o.metaFields) ? o.metaFields : Object.keys(e.meta)).forEach(function (t) {
                    i[t] = e.meta[t]
                }), new (e.remote.providerOptions.provider ? __Provider_212 : __RequestClient_212)(n.uppy, e.remote.providerOptions).post(e.remote.url, ___extends_212({}, e.remote.body, {endpoint: o.endpoint, size: e.data.size, fieldname: o.fieldName, metadata: i, headers: o.headers})).then(function (i) {
        ...
        return o.getUploadParameters = function (e) {
            ...
            return Promise.all(e.map(function (e) {
                ...
                e.forEach(function (e, o) {
                    ...
                    if (i && !i.error) {
                        var s = r[o], a = s.method, l = void 0 === a ? "post" : a, u = s.url, c = s.fields, p = s.headers, d = {method: l, formData: "post" === l.toLowerCase(), endpoint: u, metaFields: c ? Object.keys(c) : []};
                        p && (d.headers = p);
    ...
    var _$lib_93 = (___temp_93 = ___class_93 = function (e) {
        ...
        return o.resetUploaderReferences = function (e, t) {
            ...
            }), this.client.post("s3/multipart", {filename: e.name, type: e.type, metadata: t}).then(__assertServerError_93)
            ...
            return this.resetUploaderReferences(e.id), new Promise(function (r, n) {
                ...
                t.uppy.emit("upload-started", e), new (e.remote.providerOptions.provider ? __Provider_93 : __RequestClient_93)(t.uppy, e.remote.providerOptions).post(e.remote.url, ___extends_93({}, e.remote.body, {protocol: "s3-multipart", size: e.data.size, metadata: e.meta})).then(function (r) {
    ...
    var _$lib_168 = (___temp_168 = ___class_168 = function (e) {
            ...
            return o.handleResetProgress = function () {
                ...
                return new Promise(function (t, r) {
                    ...
                    n.uppy.emit("upload-started", e), new (e.remote.providerOptions.provider ? __Provider_168 : __RequestClient_168)(n.uppy, e.remote.providerOptions).post(e.remote.url, ___extends_168({}, e.remote.body, {endpoint: o.endpoint, uploadUrl: o.uploadUrl, protocol: "tus", size: e.data.size, metadata: e.meta})).then(function (t) {
    ...
    if (_$pollingXhr_22 = XHR, _$pollingXhr_22.Request = Request, _$componentInherit_12(XHR, _$Polling_23), XHR.prototype.supportsBinary = !0, XHR.prototype.request = function (e) {
        ...
        var r = "string" != typeof e && void 0 !== e, n = this.request({method: "POST", data: e, isBinary: r}), o = this;
    ...
    var TransloaditAssembly = function (e) {
        ...
        return t.createAssembly = function (e) {
            ...
            return fetch("https://status.transloadit.com/client_error", {method: "post", body: JSON.stringify({endpoint: r, instance: n, assembly_id: o, agent: "undefined" != typeof navigator ? navigator.userAgent : "", error: i})}).then(function (e) {
                return e.json()
            })
